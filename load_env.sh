...
conf_vars=(
    ...
    "LOPCO_UM_UPDATE_AUTOMATIC=True"
    ...
    "LOPCO_BM_AUTOBACKUP_ENABLED=True"
    "LOPCO_BM_AUTOBACKUP_SECOND=30"
    "LOPCO_BM_AUTOBACKUP_MINUTE=30"
    "LOPCO_BM_AUTOBACKUP_HOUR=1"
    "LOPCO_BM_AUTOBACKUP_INTERVAL=10800"
    "LOPCO_BM_AUTOBACKUP_MAX_DAYS=60"
    "LOPCO_GUI_PORT=8080"
)
